class Pphlx < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://pphlx.org/downloads/pphlx-darwin-arm64.tar.gz"
      sha256 "47b367edf00214f3a9d96fe9c9d1a463e46753769fc5e8aaf81a5747dedb2578"
    else
      url "https://pphlx.org/downloads/pphlx-darwin-amd64.tar.gz"
      sha256 "0e178a9886af5448aac8c7882b83d608834f35c7e5f5f104e2f8ed6737906a74"
    end
  elsif OS.linux?
    if Hardware::CPU.arm?
      url "https://pphlx.org/downloads/pphlx-linux-arm64.tar.gz"
      sha256 "d119908a9cdbf24f0ca6f9b06757827630b870f6000c2c572b6a449fc7b92aaa"
    else
      url "https://pphlx.org/downloads/pphlx-linux-amd64.tar.gz"
